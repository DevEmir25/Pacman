...
const guclendirmeSuresi = 2000; //ms
...
function kaybettin() {
    ...
    window.location.href = "yenidenBaslaEkrani3.html"

}
function kazandin() {
    setTimeout(() => { cancelAnimationFrame(animasyonId), window.location.href = "gecis4.html" }, 40)
